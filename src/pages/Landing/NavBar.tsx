...
const NavBar = ({onChangeUrl}:LandingPageProps) => {
 
	return (
		<Navbar collapseOnSelect expand="lg" variant="dark" className="py-lg-3 navbar-dark bg-black bg-gradient">
			<Container>
				...
				<Navbar.Collapse id="responsive-navbar-nav">
					...
					<ul className="navbar-nav ms-auto align-items-center">
						<li className="nav-item me-0">
							...
							>
								<i className="mdi mdi-basket me-2" />reservaSoft
							</a>
						</li>
					</ul>
				</Navbar.Collapse>
