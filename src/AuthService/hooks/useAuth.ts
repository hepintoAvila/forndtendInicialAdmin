...
import { AuthData, Menu, MenuItem, Permiso, User } from '@/AuthService/type';
import { encodeBasicUrl, useThemeContext } from '@/common';
...
export default function useAuth(){
 ...
 const authContext = useContext(AuthContext);
  ...
  const login = async (credentialsAuth: User) => {
    console.log('Login called with credentials:', credentialsAuth);
