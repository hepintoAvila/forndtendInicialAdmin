...
const Table = (props: TableProps): React$Element<React$FragmentType> => {
    ...
    // Obtener los datos actuales del sessionStorage si existen
    let dataInsessionStorage = sessionStorage.getItem('LiquidarCantidad');
    let data = dataInsessionStorage ? JSON.parse(dataInsessionStorage) : [];
    return (
        <>
